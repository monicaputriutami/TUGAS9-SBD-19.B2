...
{	
	...
	"UPDATE barang SET id_barang='$id_barang',nama_barang='$jnama_barang',jenis_barang='$jenis_barang',stok_barang='$stok_barang',warna_barang='$warna_barang',harga_barang='$harga_barang' 
	WHERE id_barang=$id");
